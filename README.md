...
Examples are: Marklin 6021, Marklin Mobile station (not version 1), Marklin Central Station, Intellibox, ESU ECOS 
Computer controlled layouts are no problem, as long the signal is the Marklin MM2 protocol.
